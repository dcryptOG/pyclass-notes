...
# In the above program, we define c as a global keyword inside the add_() function.

# Then, we increment the variable c by 1, i.e c = c + 2. After that, we call the add_() function. Finally, we print global variable c.
